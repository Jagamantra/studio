...
export const projectConfig: ProjectConfig = {
  ...
  availableAccentColors: [
    { name: 'Teal', hslValue: '180 100% 25%' },
    { name: 'Blue', hslValue: '221.2 83.2% 53.3%' },
    { name: 'Rose', hslValue: '346.8 77.2% 49.8%' },
    { name: 'Green', hslValue: '142.1 70.6% 45.3%' },
    { name: 'Orange', hslValue: '24.6 95% 53.1%' },
  ],
