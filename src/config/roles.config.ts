...
export const rolesConfig: RolesConfig = {
  ...
  // 'guest' role is typically for unauthenticated users, relevant for /login, /register.
  routePermissions: {
    ...
    '/login': ['guest'],
    '/register': ['guest'],
    '/mfa': ['guest'], // MFA might be accessible post-login attempt but before full session
  },
